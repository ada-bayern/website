...
extra.cards=[
  { title = "Bedarfsträger", content = "[Staatliche Archive Bayerns](https://www.gda.bayern.de/)" },
  { title = "Projekthighlight", content = "Das Pilotprojekt und die Methodik, die aus der Workshopserie hervorgingen werden in [diesem Artikel](https://doi.org/10.5771/2699-1284-2024-2-106) ausführlich beschrieben." },
...
### Zielsetzung
Entscheidungen zur Aktenauswahl sollten durch die systematische Nutzung vorhandener Daten effizienter und transparenter getroffen werden.
...
* Entwicklung eines neuen Verfahren für die Bewertung von Akten auf Basis von Metadaten: **stratifizierte, repräsentative Stichprobenziehung**.
